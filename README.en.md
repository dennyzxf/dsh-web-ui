...
![On/Off Toggle](docs/screenshots/Image-background-tuner/en/en-01.png)

![Real-Time Adjustment](docs/screenshots/Image-background-tuner/en/en-02.png)

![Upload Background Image](docs/screenshots/Image-background-tuner/en/en-03.png)
